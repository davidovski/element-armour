...
public class ArmourUtil {
    ...
    public static org.bukkit.inventory.ItemStack createLightEssence() {
        ...
        meta.setDisplayName(ChatColor.WHITE + "Light Essence");

        List<String> lores = new ArrayList();
        lores.add(ChatColor.WHITE + "" +ChatColor.UNDERLINE + "███");
        lores.add(ChatColor.WHITE + "" + ChatColor.UNDERLINE + "███");
        lores.add(ChatColor.WHITE + "" + ChatColor.UNDERLINE + "███");
    ...
    public static org.bukkit.inventory.ItemStack createDarkEssence() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(ChatColor.BLACK + "Dark Essence");

        List<String> lores = new ArrayList();
        lores.add(ChatColor.BLACK + "" + ChatColor.MAGIC + "Dark Essence");
        lores.add(ChatColor.BLACK + "" + ChatColor.MAGIC + "Dark Essence");
        lores.add(ChatColor.BLACK + "" + ChatColor.MAGIC + "Dark Essence");
        lores.add(ChatColor.BLACK + "" + ChatColor.MAGIC + "Dark Essence");
        lores.add(ChatColor.BLACK + "" + ChatColor.MAGIC + "Dark Essence");
