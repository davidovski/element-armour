...
public class UndeathController extends CustomEntityController {
    ...
    public LivingEntity spawn(Location loc) {
        ...
        //zombie.getAttribute(Attribute.GENERIC_ATTACK_SPEED).setBaseValue(0.05f);
        zombie.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(64);
        zombie.setHealth(64);
    ...
    public List<ItemStack> getDrops() {
        ...
        drops.add(DropGenerator.i(Material.INK_SACK));
        return drops;
    }
