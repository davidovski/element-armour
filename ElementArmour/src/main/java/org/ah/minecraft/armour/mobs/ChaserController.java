...
public class ChaserController extends CustomEntityController {
    ...
    public LivingEntity spawn(Location loc) {
        ...
        zomb.setLeggingsDropChance(2f);

        //zombie.getWorld().createExplosion(zombie.getLocation(), 3f);

        //zombie.addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 1000000, 255));
